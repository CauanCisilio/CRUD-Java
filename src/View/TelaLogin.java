...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/5883.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtUsuario.getText().isEmpty() && !txtSenha.getText().isEmpty()) {
            ...
            // a variável loginSucesso do tipo boleano armazena o resultado do metodo logar
            //caso retorne verdadeiro exibe a tela principal
            Login login = new Login();
            boolean loginSucesso = login.Logar(usuario, senha);
